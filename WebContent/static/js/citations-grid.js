...
CitationPanel = Ext.extend(Ext.Panel, {
	grid: null,
	store: null,
	filter: null,
	pageLimit: 50,
	...
	initComponent: function()
    {
		...
		this.statusStore = new Ext.data.JsonStore({
			url: _contextPath + '/citation/statsList',
			baseParams: {},
			root: 'status',
	        totalProperty: 'count',
	        remoteSort: true,
	    ...
	    this.store = new Ext.data.JsonStore({
	        ...
	        fields: [
	            ...
	            'appeal_status',
	            'notes',
	            {name:'citation_date', type: 'date', dateFormat:'Y-m-dTH:i:s'},
	            'license', 
	            'vin', 
	            'violation_id',
	            'community_service_end',
	   ...
	   /* 
	    ...
	    var columnModel = new Ext.grid.ColumnModel({
	        ...
	        ,{
	            ...
	            header: "Exported",
	            dataIndex: 'exported',
	            renderer: function(value) { return (value)?'Yes':'No'; },
	            width: 75
	        },{
	            header: "Date",
	    ...
	    this.filter = new Ext.FormPanel({
			...
			items:[
			       {
			    	   name: 'filter_citation_number',
			    	   fieldLabel: 'Number'
			       },
			       {
			    	   xtype: 'combo',
			    	   hiddenName: 'filter_citation_status',
			    	   fieldLabel: 'Status',
			    	   submitValue: true,
		               width: 165,
					 	lazyRender: false,
			       ...
			       {
			    	   name: 'filter_citation_license',
			    	   fieldLabel: 'License'
			       },
			       {
			    	   name: 'filter_citation_vin',
			    	   fieldLabel: 'VIN'
			       },
			       {
			    	   name: 'filter_citation_officer_id',
			    	   fieldLabel: 'Officer ID'
			       },
			       {
			    	   name: 'filter_citation_start_date',
			    	   fieldLabel: 'Start Date',
			    	   xtype: 'datefield'
			       },
			       {
			    	   name: 'filter_citation_end_date',
			    	   fieldLabel: 'End Date',
			    	   xtype: 'datefield'
			       }
			       ],
