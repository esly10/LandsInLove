ReservationPanel = Ext.extend(Ext.Panel, {
																		...
																		listeners:{
																	    	change : function(val){
																	    		...
																	    		if(Ext.getCmp("reservation_check_out").getValue() != "" && Ext.getCmp("reservation_check_in").getValue() != ""){
																    			    ...
																    			    roomsStore.load({
																    					params:{'reservation_check_out': Ext.getCmp("reservation_check_out").getValue(), 'reservation_check_in': Ext.getCmp("reservation_check_in").getValue()},
																    					callback: function () {
																...
																items: [
																		...
																		},
																		{
																			  ...
																			  store: new Ext.data.ArrayStore({
																			      ...
																			      data : [
																			              [1, 'reservation_meal_plan 1'],
																			              [2, 'reservation_meal_plan 2'],
																			              [3, 'reservation_meal_plan 3'],
																			      ]
																			    }),
															...
															items:[
																{
																	...
																	items: [
																	        ...
																	        },
																	        {
																	        	...
																	        	listeners:{
																	        		check: function(self, newVal, oldVal) {
																	        			if(Ext.getCmp("check_out_radio").checked){																	        				
	    ...
	    loadDataReservation : function(){
	    	...
	    	if(panel.reservationInfo !== undefined){
	    		 ...
	    		 for (var prop in panel.reservationInfo) {
	    			 if(Ext.getCmp(prop) !== undefined){
	    				 ...
	    				 if(prop == "reservation_number"){
	    					 ...
	    					 document.getElementById("status").innerHTML = panel.reservationInfo[prop];
	    		...
	    		/* Ext.getCmp("sub_total").setValue(panel.total_charges);	    		 
	    		 ...
	    		 //console.log(nop);
	    		 //Ext.getCmp("reservation_type").fireEvent("select");
	    	}
	    ...
	    submitReservaion: function(type){
			...
			Ext.apply
    		(
    			values, {'reservation_number': res_number}
    		);
	    ...
	    submitCharges: function(id){ 	    		
	    	var data = {};
	    	id = 10;
	    	ChargeGrid.getStore().each(function(record,id){
	    	  
	    	   
	    		   data.charge_reservation_id = id;
	            ...
	            buttons: [{
	                ...
	                {   
	                	...
	                	Ext.getCmp('formPayment').getForm().submit({
	                	    ...
	                	    scope: this,
	                	    params: {transaction_id: 1 }, //panel.transaction_id  FIX
	                	    success: function(form, action) {
	    	 ...
	    	 var toolbar = null;
	    	  ...
	    	  payentsColumnModel = new Ext.grid.ColumnModel({
			       ...
			       columns:[
					           ...
					           {header: 'Payment Method', sortable: true, dataIndex: 'payment_method',  autoSizeColumn : true},
