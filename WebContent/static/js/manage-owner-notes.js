OwnerNotesPanel = Ext.extend(Ext.Panel, {
		owner: null,
		initComponent: function()
	    {
			...
			var config = 
			{
				xtype: 'panel',
			    title: 'Notes',
			    id: 'ownertab-notes-' + this.owner.owner_id,
			    padding: 5,
			    bodyCssClass: 'x-citewrite-panel-body',
			    autoScroll: true,
			    buttonAlign: 'left',
			    autoLoad : { url : _contextPath + '/owner/notes', scripts : true, params: {owner_id: this.owner.owner_id } },
			...
			OwnerNotesPanel.superclass.initComponent.apply(this, arguments);
	    },
