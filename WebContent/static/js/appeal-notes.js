AppealNotesPanel = Ext.extend(Ext.Panel, {
		...
		initComponent: function()
	    {
			...
			var config = 
			{
				xtype: 'panel',
			    title: 'Notes',
			    id: 'citationtab-notes-' + this.citation_appeal_id,
			    padding: 5,
			    bodyCssClass: 'x-citewrite-panel-body',
			    autoScroll: true,
			    buttonAlign: 'left',
			    autoLoad : { url : _contextPath + '/citation/appealNotes', scripts : true, params: {citation_appeal_id: this.citation_appeal_id} },
	            ...
	            buttons: [{
	                ...
	                {   
	                	...
	                	formPanel.getForm().submit({
	                	    ...
	                	    scope: this,
	                	    params: {xaction: 'save', citation_appeal_id: panel.citation_appeal_id },
	                	    success: function(form, action) {
	                	    	panel.load({url : _contextPath + '/citation/appealNotes'});
	    ...
	    {
	    	var panel = this;
	    	var container = Ext.get('citation-appeal-notes-'+this.citation_appeal_id);
				...
				if(p1 != 'no')
				{
					...
					Ext.Ajax.request({
					   ...
					   success: function(response, opts){
						   panel.load({ url : _contextPath + '/citation/appealNotes', scripts : true, params: {citation_appeal_id: panel.citation_appeal_id} });
					   ...
					   params: { note_id: note_id, citation_appeal_id: panel.citation_appeal_id, xaction: 'delete' }
					});
				}
			});
	    }
